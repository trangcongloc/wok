...
document.querySelectorAll('[aria-label="Trái tim"]').forEach(heart=>heart.click())
...
document.querySelectorAll('[aria-label="Thích bình luận này cùng với 0 người khác"]').forEach(like=>like.click())
console.log("Liked")
